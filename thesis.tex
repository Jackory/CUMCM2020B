...
\section{问题三}
$\max Q+Q_{Mine}(m_4+m_5+m_6+m_7+m_8)-2(n_{sw}p_w+n_{sf}p_f)(n_1+n_3+n_4+n_5+n_6)-2(n_{hw}p_w+n{hf}p_f)(n_2+n_7+n_8+n_9+n_{10})-3(n_{sw}p_w+n_{sf}p_f)(m_4+m_5+m_6)-3(n_{hw}p_w+n_{hf}p_f)(m_7+m_8)-(n_{hw}p_w+n_{hf}p_f)(1-n_2+1-n_7-m_7+1-n_8-m_8)-(n_{sw}p_w+n_{sf}p_f)(1-n_4-m_4+1-n_5-m_5+1-n_6-m_6)$
%参考文献
